...
<!-- first section -->
  ...
  <ul class="flex my-7">
    ...
    <li class="mx-6"><a class="bg-cyan-900 rounded-md px-3 text-white py-3 hover:bg-cyan-700" href="login.php">Log in </a></li>
    <li class="mx-6"><a class="bg-rose-900 rounded-md px-3 text-white py-3 hover:bg-rose-700" href="login.php">Register </a></li>
...
<div class="text-center">
    ...
    <button class="bg-rose-900 text-white px-28 rounded-md text-center py-3 mt-8 hover:bg-rose-700 ">Start learning now!</button>
...
<div class="flex mt-5">
    ...
    <div class="bg-white rounded-md mx-10 py-1 px-6 flex shadow-lg shadow-cyan-500/50 hover:bg-yellow-500 hover:text-white">
        <img src="./js.webp" class="w-12 rounded-full object-contain mr-5" alt="image of javascript">
    ...
    <div class="bg-white rounded-md mx-10 py-1 px-6 flex shadow-lg shadow-cyan-500/50 hover:bg-red-500 hover:text-white">
        <img src="./java.webp" class="w-12 rounded-full object-contain mr-5" alt="image of javascript">
    ...
    <div class="bg-white rounded-md mx-10 py-1 px-6 flex shadow-lg shadow-cyan-500/50 hover:bg-orange-600 hover:text-white">
        <img src="./html image.png" class="w-12 rounded-full object-contain mr-5" alt="image of javascript">
    ...
    <div class="bg-white rounded-md mx-10 py-1 px-6 flex shadow-lg shadow-cyan-500/50 hover:bg-blue-600 hover:text-white">
        <img src="./css.png" class="w-12 rounded-full object-contain mr-5" alt="image of javascript">
